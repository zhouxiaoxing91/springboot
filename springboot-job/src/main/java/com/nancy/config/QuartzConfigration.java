package com.nancy.config;

import com.nancy.job.TestJob;
...
public class QuartzConfigration {
     ...
     */
    @Bean(name = "jobDetail")
    public MethodInvokingJobDetailFactoryBean detailFactoryBean(TestJob testJob) {// ScheduleTask为需要执行的任务
    ...
    public CronTriggerFactoryBean cronJobTrigger(@Qualifier("jobDetail") MethodInvokingJobDetailFactoryBean jobDetailBean) {
